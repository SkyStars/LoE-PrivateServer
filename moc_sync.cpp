...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Sync_t, stringdata) + ofs \
...
const QMetaObject Sync::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Sync.data,
      qt_meta_data_Sync,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Sync.stringdata))
        return static_cast<void*>(const_cast< Sync*>(this));
